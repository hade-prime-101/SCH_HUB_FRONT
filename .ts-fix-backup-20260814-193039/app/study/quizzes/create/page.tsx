        ...
        <div className="bg-card rounded-2xl border border-border p-6 space-y-4">
          <div>
            ...
            <Input
              id="materialId"
              value={materialId}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setMaterialId(e.target.value)}
          ...
          <div>
            ...
            <Input
              ...
              max={20}
              value={numQuestions}
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setNumQuestions(Number(e.target.value))}
            />
          </div>
