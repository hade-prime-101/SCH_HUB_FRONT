    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-card rounded-2xl border border-border p-6 space-y-4">
        <div>
          ...
          <Input id="title" value={title} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setTitle(e.target.value)} />
        </div>
      </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <Textarea
                  id={`q${qi}-text`}
                  value={q.text}
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateQuestion(qi, "text", e.target.value)}
                  rows={2}
                />
              </div>
              <div>
                ...
                <div>
                  ...
                  {q.options?.map((opt, oi) => (
                    <div key={oi} className="flex gap-2 mt-1">
                      <Input
                        value={opt}
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateOption(qi, oi, e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateQuestion(qi, "correctAnswer", e.target.value)}
                />
              </div>
            </div>
          </div>
