  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <Link href="/study/materials/upload" className="bg-primary hover:opacity-90 text-primary-foreground px-6 py-2 rounded-lg font-medium transition-opacity flex items-center gap-2">
          <FileText size={20} />
          Upload New
        </Link>
      </div>
      ...
      {!loading && materials.length === 0 && (
        <div className="text-center py-12 bg-muted rounded-lg border-2 border-dashed border-gray-300">
          ...
          <Link href="/study/materials/upload" className="bg-primary hover:opacity-90 text-primary-foreground px-6 py-2 rounded-lg font-medium transition-opacity inline-block">
