    ...
    <div>
      ...
      {cgpaData ? (
        ...
        <div className="bg-warning/5 p-4 rounded mb-6">
          No CGPA data yet. <Link href="/study/cgpa/courses" className="text-primary underline">Add courses</Link> and calculate.
        </div>
      )}
