  ...
  return (
    <div>
      <div className="flex justify-between mb-4">
        ...
        <button onClick={() => setShowForm(true)} className="bg-primary text-primary-foreground px-4 py-2 rounded">Add Admin</button>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-card rounded p-6 w-96">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={handleCreate} className="bg-success text-primary-foreground px-4 py-2 rounded">Create</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-card rounded p-6 w-96">
            ...
            <div className="flex justify-end gap-2 mt-4">
              <button onClick={() => setResetPassId(null)} className="bg-secondary/50 px-4 py-2 rounded">Cancel</button>
              <button onClick={() => handleResetPassword(resetPassId, (document.getElementById('newpass') as HTMLInputElement).value)} className="bg-primary text-primary-foreground px-4 py-2 rounded">Reset</button>
            </div>
          </div>
        </div>
      )}
          ...
          {admins.map(admin => (
            <tr key={admin.id} className="border-t">
              ...
              <td className="p-2 text-right">
                <button onClick={() => handleToggleActive(admin)} className="text-primary mr-2">
