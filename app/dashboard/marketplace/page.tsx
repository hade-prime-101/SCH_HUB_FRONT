  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/dashboard/marketplace/listings" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Buy & Sell</h2>
          <p className="text-muted-foreground">Browse listings or sell your items</p>
        </Link>
        <Link href="/dashboard/marketplace/shops" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Shops</h2>
          <p className="text-muted-foreground">Discover school vendors</p>
        </Link>
        <Link href="/dashboard/marketplace/lost-found" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Lost & Found</h2>
          <p className="text-muted-foreground">Report lost or found items</p>
        </Link>
        <Link href="/dashboard/marketplace/accommodation" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Accommodation</h2>
          <p className="text-muted-foreground">Find hostels & apartments</p>
        </Link>
        <Link href="/dashboard/marketplace/roommates" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Roommates</h2>
          <p className="text-muted-foreground">Find or offer a shared room</p>
        </Link>
        <Link href="/dashboard/marketplace/services" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Services</h2>
          <p className="text-muted-foreground">Offer or hire services</p>
        </Link>
        <Link href="/dashboard/marketplace/jobs" className="bg-card shadow rounded p-6 hover:shadow-md">
