  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/dashboard/school/timetable" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Timetable</h2>
          <p className="text-muted-foreground">View & manage your class schedule</p>
        </Link>
        <Link href="/dashboard/school/events" className="bg-card shadow rounded p-6 hover:shadow-md">
          <h2 className="text-xl font-semibold">Events</h2>
          <p className="text-muted-foreground">Upcoming school events</p>
        </Link>
        <Link href="/dashboard/school/emergency" className="bg-card shadow rounded p-6 hover:shadow-md">
