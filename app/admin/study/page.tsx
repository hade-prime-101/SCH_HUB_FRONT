    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-gray-500">Approve or reject uploaded materials</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-gray-500">View, delete, and approve questions</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="text-gray-500">View overall quiz performance</p>
        </Link>
      </div>
    </div>
  );
