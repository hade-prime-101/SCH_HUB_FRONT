 ...
 */
import { NavigationItem, NavigationConfig, UserRole, FeatureFlagKey } from './navigation.types';
/**
 ...
 */
export declare function filterNavigationItems(items: NavigationConfig, userRoles: UserRole[], featureFlags: Record<FeatureFlagKey, boolean>, removeEmptyGroups?: boolean): NavigationItem[];
/**
 ...
 */
export declare function findItemById(items: NavigationConfig, itemId: string): NavigationItem | null;
/**
 ...
 */
export declare function findActiveItemId(items: NavigationConfig, currentPath: string): string | null;
/**
 ...
 */
export declare function getGroupsToExpand(items: NavigationConfig, activeItemId: string | null): Set<string>;
/**
 ...
 */
export declare function getItemPath(items: NavigationConfig, targetItemId: string): string[];
